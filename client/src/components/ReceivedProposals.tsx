...
import { acceptProposal, declineProposal, getReceivedProposals } from '@/lib/features/server_requests/proposals';
          ...
          <Suspense fallback={<div>Loading...</div>}>
            <TableBody className="w-full">
              {receivedProposals.map((receivedProposal: Proposal) => (
                <TableRow
                  key={receivedProposal.id}
                  className="cursor-pointer"
                  onClick={() => handleLotClick(receivedProposal.offeredLotId as string)}
                >
                  <TableCell className="text-center capitalize">
                    {receivedProposal.offeredLot?.name}
                  </TableCell>
                  <TableCell className="text-center capitalize">
                    {receivedProposal.status}
                  </TableCell>
