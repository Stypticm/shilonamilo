...
import { offMessage, onMessageReceived, onJoinChat } from '@/lib/features/websockets/chatHandlerClient';
import {
  joinRoom,
  onProposalReceived,
  offProposal,
} from '@/lib/features/websockets/proposalHandlerclient';
...
export const useChatNotifications = ({
  ...
  useEffect(() => {
    if (userId) {
      ...
      onMessageReceived(handleChatNotification);
