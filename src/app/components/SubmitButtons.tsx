    ...
    return (
        <>
            {pending ? (
                ...
                <Button variant='ghost' size='icon' className='bg-slate-400 hover:bg-yellow-400' type='submit'>
    ...
    return (
        <>
            {pending ? (
                ...
                <Button variant='ghost' size='icon' className='bg-yellow-400 hover:bg-slate-400' type='submit'>
                    <Star className='w-6 h-6' />
                </Button >
            )}
        </>
