                        ...
                        {message.senderId === user?.uid ? (
                            <section className='w-full h-full flex justify-end'>
                                ...
                                <section className='w-1/5 flex justify-center items-center'>
                                    <Image src={
                                        user?.photoURL || "https://static.vecteezy.com/system/resources/thumbnails/009/292/244/small/default-avatar-icon-of-social-media-user-vector.jpg"
                                    }
                                        alt="User avatar"
                            ...
                            <section className='w-full h-full flex justify-start'>
                                <section className='w-1/5 flex justify-center items-center'>
                                    <Image src={
                                        companion?.photoURL || "https://static.vecteezy.com/system/resources/thumbnails/009/292/244/small/default-avatar-icon-of-social-media-user-vector.jpg"
                                    }
                                        alt="User avatar"
                                        className='rounded-full h-11 w-11 hidden md:block'
                                        width={48}
