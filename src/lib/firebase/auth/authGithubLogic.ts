...
const githubAuthSignUp = (setUser: React.Dispatch<React.SetStateAction<User | null>>) => handleGithubAuth(setUser, githubProvider);

export const handleGithubAuth = async (setUser: React.Dispatch<React.SetStateAction<User | null>>, provider: any) => {
    try {
...
export const githubProviderAuth = async ({ setUser, closeModal }: { setUser: React.Dispatch<React.SetStateAction<User | null>>, closeModal?: () => void }) => {
    try {
