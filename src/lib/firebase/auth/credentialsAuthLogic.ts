...
export const handleLogin = async (email: string, password: string, setUser: React.Dispatch<React.SetStateAction<User | null>>, closeModal?: () => void) => {
...
export const handleReg = async (email: string, name: string, password: string, setUser: React.Dispatch<React.SetStateAction<User | null>>, closeModal?: () => void) => {
    try {
